 ...
 * - Magento2.order.refund() | offline refund an order. Refer to invoice endpoint for online refund option
 ...
 * - Magento2.order.setEmailAddress() | Update email address of a guest order - Customized endpoint
 * 
...
module.exports = (service)=> {
  return {
    ...
    setEmailAddress: (data)=> service.post(`${path}/set-email-address`, data)
  };
}